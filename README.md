...
2) Add `compile 'com.github.evgenyneu:js-evaluator-for-android:v1.0.7'` into **dependencies** section of your **module** build.gradle file. For example:
...
For less information, see Gradle/Maven [setup instructions](https://jitpack.io/#evgenyneu/js-evaluator-for-android/v1.0.7) on JsEvaluator jitpack.io page.
