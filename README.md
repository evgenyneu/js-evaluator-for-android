...
2) Add `compile 'com.github.evgenyneu:js-evaluator-for-android:v1.0.6'` into **dependencies** section of your **module** build.gradle file. For example:

```gradle
dependencies {
    compile fileTree(dir: 'libs', include: ['*.jar'])
    // Keep you existing dependencies here
    compile 'com.github.evgenyneu:js-evaluator-for-android:v1.0.6'
}
```

For less information, see Gradle/Maven [setup instructions](https://jitpack.io/#evgenyneu/js-evaluator-for-android/v1.0.6) on JsEvaluator jitpack.io page.
